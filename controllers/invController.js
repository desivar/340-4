...
  console.log(`[DEBUG] buildByClassificationId - classification_id: ${classification_id}`); // ADDED

  const data = await invModel.getInventoryByClassificationId(classification_id);
  console.log(`[DEBUG] buildByClassificationId - data length: ${data ? data.length : 0}`); // ADDED
  console.log(`[DEBUG] buildByClassificationId - data:`, data); // ADDED
